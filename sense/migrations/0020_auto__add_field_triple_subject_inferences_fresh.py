...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Triple.subject_inferences_fresh'
        db.add_column(u'sense_triple', 'subject_inferences_fresh',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Triple.subject_inferences_fresh'
        db.delete_column(u'sense_triple', 'subject_inferences_fresh')
    ...
    models = {
        ...
        u'sense.triple': {
            ...
            'subject_inferences_fresh': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
