...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TripleFlow'
        db.create_table(u'sense_tripleflow', (
            ...
            ('context', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flows', to=orm['sense.Context'])),
            ('triple', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flows', to=orm['sense.Triple'])),
            ('index', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True)),
        ))
        db.send_create_signal(u'sense', ['TripleFlow'])


    def backwards(self, orm):
        # Deleting model 'TripleFlow'
        db.delete_table(u'sense_tripleflow')
    ...
    models = {
        ...
        u'sense.tripleflow': {
            'Meta': {'object_name': 'TripleFlow', 'index_together': '()'},
