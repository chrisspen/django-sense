...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredicateObjectIndex.depth'
        db.add_column(u'sense_predicateobjectindex', 'depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredicateObjectIndex.depth'
        db.delete_column(u'sense_predicateobjectindex', 'depth')
