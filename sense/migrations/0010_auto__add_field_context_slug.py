...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'sense_context', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=500, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.slug'
        db.delete_column(u'sense_context', 'slug')
