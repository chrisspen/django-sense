...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TripleInference'
        db.create_table(u'sense_tripleinference', (
            ...
            ('inferred_triple', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inferences', to=orm['sense.Triple'])),
            ('inference_rule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sense.InferenceRule'], null=True, blank=True)),
            ('inference_arguments_cache', self.gf('django.db.models.fields.CharField')(max_length=700, null=True, blank=True)),
            ('inferred_weight', self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'sense', ['TripleInference'])

        # Adding M2M table for field inference_arguments on 'TripleInference'
        m2m_table_name = db.shorten_name(u'sense_tripleinference_inference_arguments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tripleinference', models.ForeignKey(orm[u'sense.tripleinference'], null=False)),
            ('triple', models.ForeignKey(orm[u'sense.triple'], null=False))
        ))
        db.create_unique(m2m_table_name, ['tripleinference_id', 'triple_id'])

        # Adding unique constraint on 'TripleInference', fields ['inferred_triple', 'inference_rule', 'inference_arguments_cache']
        db.create_unique(u'sense_tripleinference', ['inferred_triple_id', 'inference_rule_id', 'inference_arguments_cache'])


    def backwards(self, orm):
        # Removing unique constraint on 'TripleInference', fields ['inferred_triple', 'inference_rule', 'inference_arguments_cache']
        db.delete_unique(u'sense_tripleinference', ['inferred_triple_id', 'inference_rule_id', 'inference_arguments_cache'])

        # Deleting model 'TripleInference'
        db.delete_table(u'sense_tripleinference')

        # Removing M2M table for field inference_arguments on 'TripleInference'
        db.delete_table(db.shorten_name(u'sense_tripleinference_inference_arguments'))
