...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TripleFlow.index'
        db.alter_column(u'sense_tripleflow', 'index', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TripleFlow.index'
        db.alter_column(u'sense_tripleflow', 'index', self.gf('django.db.models.fields.PositiveIntegerField')())
