...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sense.mutually_exclusive_subject_predicate'
        db.add_column(u'sense_sense', 'mutually_exclusive_subject_predicate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sense.mutually_exclusive_subject_predicate'
        db.delete_column(u'sense_sense', 'mutually_exclusive_subject_predicate')
    ...
    models = {
        ...
        u'sense.predicateobjectindex': {
            'Meta': {'unique_together': "(('context', 'predicate', 'object'),)", 'object_name': 'PredicateObjectIndex', 'index_together': "(('context', 'predicate', 'object'),)"},
