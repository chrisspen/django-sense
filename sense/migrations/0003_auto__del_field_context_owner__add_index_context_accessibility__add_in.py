...
#
#        # Deleting field 'Context.owner'
#        db.delete_column(u'sense_context', 'owner_id')
#
#        # Adding index on 'Context', fields ['accessibility']
#        db.create_index(u'sense_context', ['accessibility'])
#
#        # Adding index on 'Context', fields ['editability']
#        db.create_index(u'sense_context', ['editability'])
        pass


    def backwards(self, orm):
        # Removing index on 'Context', fields ['editability']
        db.delete_index(u'sense_context', ['editability'])

        # Removing index on 'Context', fields ['accessibility']
        db.delete_index(u'sense_context', ['accessibility'])

        # Adding field 'Context.owner'
        db.add_column(u'sense_context', 'owner',
    ...
    models = {
        u'sense.context': {
            'Meta': {'unique_together': '()', 'object_name': 'Context'},
