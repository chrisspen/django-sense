...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context.missing_truth_value'
        db.add_column(u'sense_context', 'missing_truth_value',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.missing_truth_value'
        db.delete_column(u'sense_context', 'missing_truth_value')
