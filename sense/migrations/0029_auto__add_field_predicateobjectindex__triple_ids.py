...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredicateObjectIndex._triple_ids'
        db.add_column(u'sense_predicateobjectindex', '_triple_ids',
                      self.gf('django.db.models.fields.TextField')(null=True, db_column='triple_ids', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredicateObjectIndex._triple_ids'
        db.delete_column(u'sense_predicateobjectindex', 'triple_ids')
