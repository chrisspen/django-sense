...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sense.language'
        db.add_column(u'sense_sense', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=2),
                      keep_default=False)

        # Adding field 'Sense.conceptnet_uri'
        db.add_column(u'sense_sense', 'conceptnet_uri',
                      self.gf('django.db.models.fields.URLField')(max_length=700, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Triple.conceptnet_uri'
        db.add_column(u'sense_triple', 'conceptnet_uri',
                      self.gf('django.db.models.fields.URLField')(max_length=700, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Triple.conceptnet_weight'
        db.add_column(u'sense_triple', 'conceptnet_weight',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Triple.conceptnet_surface_text'
        db.add_column(u'sense_triple', 'conceptnet_surface_text',
                      self.gf('django.db.models.fields.CharField')(max_length=7700, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sense.language'
        db.delete_column(u'sense_sense', 'language')

        # Deleting field 'Sense.conceptnet_uri'
        db.delete_column(u'sense_sense', 'conceptnet_uri')

        # Deleting field 'Triple.conceptnet_uri'
        db.delete_column(u'sense_triple', 'conceptnet_uri')

        # Deleting field 'Triple.conceptnet_weight'
        db.delete_column(u'sense_triple', 'conceptnet_weight')

        # Deleting field 'Triple.conceptnet_surface_text'
        db.delete_column(u'sense_triple', 'conceptnet_surface_text')
