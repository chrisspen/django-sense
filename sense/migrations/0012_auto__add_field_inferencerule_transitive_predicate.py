...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InferenceRule.transitive_predicate'
        db.add_column(u'sense_inferencerule', 'transitive_predicate',
                      self.gf('django.db.models.fields.CharField')(default='IsA', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InferenceRule.transitive_predicate'
        db.delete_column(u'sense_inferencerule', 'transitive_predicate')
