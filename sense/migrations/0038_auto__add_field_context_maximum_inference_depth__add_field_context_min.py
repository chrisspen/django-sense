...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context.maximum_inference_depth'
        db.add_column(u'sense_context', 'maximum_inference_depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=20),
                      keep_default=False)

        # Adding field 'Context.minimum_inference_weight'
        db.add_column(u'sense_context', 'minimum_inference_weight',
                      self.gf('django.db.models.fields.FloatField')(default=0.01),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.maximum_inference_depth'
        db.delete_column(u'sense_context', 'maximum_inference_depth')

        # Deleting field 'Context.minimum_inference_weight'
        db.delete_column(u'sense_context', 'minimum_inference_weight')
