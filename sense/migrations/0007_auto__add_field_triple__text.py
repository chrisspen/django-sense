...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Triple._text'
        db.add_column(u'sense_triple', '_text',
                      self.gf('django.db.models.fields.TextField')(null=True, db_column='text', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Triple._text'
        db.delete_column(u'sense_triple', 'text')
