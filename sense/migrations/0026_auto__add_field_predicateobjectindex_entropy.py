...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredicateObjectIndex.entropy'
        db.add_column(u'sense_predicateobjectindex', 'entropy',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredicateObjectIndex.entropy'
        db.delete_column(u'sense_predicateobjectindex', 'entropy')
