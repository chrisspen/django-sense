...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sense._name'
        db.alter_column(u'sense_sense', '_name', self.gf('django.db.models.fields.CharField')(max_length=700, null=True))

    def backwards(self, orm):

        # Changing field 'Sense._name'
        db.alter_column(u'sense_sense', '_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
