...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PredicateObjectIndex.prior'
        db.add_column(u'sense_predicateobjectindex', 'prior',
        ...
        # Adding unique constraint on 'PredicateObjectIndex', fields ['context', 'best_splitter', 'depth', 'prior']
        db.create_unique(u'sense_predicateobjectindex', ['context_id', 'best_splitter', 'depth', 'prior'])

        # Removing index on 'PredicateObjectIndex', fields ['context', 'parent', 'predicate', 'object']
        db.delete_index(u'sense_predicateobjectindex', ['context_id', 'parent_id', 'predicate_id', 'object_id'])

        # Removing index on 'PredicateObjectIndex', fields ['context', 'predicate', 'object']
        db.delete_index(u'sense_predicateobjectindex', ['context_id', 'predicate_id', 'object_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding index on 'PredicateObjectIndex', fields ['context', 'predicate', 'object']
        db.create_index(u'sense_predicateobjectindex', ['context_id', 'predicate_id', 'object_id'])

        # Adding index on 'PredicateObjectIndex', fields ['context', 'parent', 'predicate', 'object']
        db.create_index(u'sense_predicateobjectindex', ['context_id', 'parent_id', 'predicate_id', 'object_id'])

        # Removing unique constraint on 'PredicateObjectIndex', fields ['context', 'best_splitter', 'depth', 'prior']
        db.delete_unique(u'sense_predicateobjectindex', ['context_id', 'best_splitter', 'depth', 'prior'])
        ...
        # Deleting field 'PredicateObjectIndex.prior'
        db.delete_column(u'sense_predicateobjectindex', 'prior')
    ...
    models = {
        ...
        u'sense.predicateobjectindex': {
            'Meta': {'ordering': "('-entropy',)", 'unique_together': "(('context', 'parent', 'predicate', 'object', 'prior'), ('context', 'best_splitter', 'depth', 'prior'))", 'object_name': 'PredicateObjectIndex', 'index_together': "(('context', 'parent', 'predicate', 'object', 'prior'), ('context', 'predicate', 'object', 'prior'), ('context', 'parent', 'predicate', 'object', 'prior'), ('context', 'predicate', 'object', 'prior'))"},
