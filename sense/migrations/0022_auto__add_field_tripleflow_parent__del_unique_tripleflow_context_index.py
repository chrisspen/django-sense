...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TripleFlow', fields ['context', 'index']
        db.delete_unique(u'sense_tripleflow', ['context_id', 'index'])

        # Adding field 'TripleFlow.parent'
        db.add_column(u'sense_tripleflow', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='flows', null=True, to=orm['sense.TripleFlow']),
                      keep_default=False)

        # Adding unique constraint on 'TripleFlow', fields ['context', 'parent', 'index']
        db.create_unique(u'sense_tripleflow', ['context_id', 'parent_id', 'index'])


    def backwards(self, orm):
        # Removing unique constraint on 'TripleFlow', fields ['context', 'parent', 'index']
        db.delete_unique(u'sense_tripleflow', ['context_id', 'parent_id', 'index'])

        # Deleting field 'TripleFlow.parent'
        db.delete_column(u'sense_tripleflow', 'parent_id')

        # Adding unique constraint on 'TripleFlow', fields ['context', 'index']
        db.create_unique(u'sense_tripleflow', ['context_id', 'index'])
    ...
    models = {
        ...
        u'sense.tripleflow': {
            'Meta': {'unique_together': "(('context', 'parent', 'index'),)", 'object_name': 'TripleFlow', 'index_together': '()'},
            'context': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flows'", 'to': u"orm['sense.Context']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'flows'", 'null': 'True', 'to': u"orm['sense.TripleFlow']"}),
            'triple': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flows'", 'to': u"orm['sense.Triple']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'})
        },
