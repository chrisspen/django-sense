...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sense.allow_predicate_usage'
        db.add_column(u'sense_sense', 'allow_predicate_usage',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sense.allow_predicate_usage'
        db.delete_column(u'sense_sense', 'allow_predicate_usage')
