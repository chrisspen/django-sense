...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TripleInference.confirmed'
        db.add_column(u'sense_tripleinference', 'confirmed',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TripleInference.confirmed'
        db.delete_column(u'sense_tripleinference', 'confirmed')
