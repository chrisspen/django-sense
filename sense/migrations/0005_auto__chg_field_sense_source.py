...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sense.source'
        db.alter_column(u'sense_sense', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sense.Source']))

    def backwards(self, orm):

        # Changing field 'Sense.source'
        db.alter_column(u'sense_sense', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sense.Source']))
