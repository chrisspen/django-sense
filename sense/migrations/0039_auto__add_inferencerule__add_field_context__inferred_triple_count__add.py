...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Context._inferred_triple_count'
        db.add_column(u'sense_context', '_inferred_triple_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, db_column='inferred_triple_count', blank=True),
                      keep_default=False)
        ...
        # Adding field 'Triple.inferred_weight'
        db.add_column(u'sense_triple', 'inferred_weight',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Triple.inference_rule'
        db.add_column(u'sense_triple', 'inference_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sense.InferenceRule'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Context._inferred_triple_count'
        db.delete_column(u'sense_context', 'inferred_triple_count')

        # Removing M2M table for field rules on 'Context'
        db.delete_table(db.shorten_name(u'sense_context_rules'))

        # Deleting field 'Triple.inferred_weight'
        db.delete_column(u'sense_triple', 'inferred_weight')

        # Deleting field 'Triple.inference_rule'
        db.delete_column(u'sense_triple', 'inference_rule_id')
