...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Sense', fields ['wordnet_id']
        db.delete_unique(u'sense_sense', ['wordnet_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Sense', fields ['wordnet_id']
        db.create_unique(u'sense_sense', ['wordnet_id'])
