...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PredicateObjectIndex', fields ['context', 'predicate', 'object']
        db.delete_unique(u'sense_predicateobjectindex', ['context_id', 'predicate_id', 'object_id'])

        # Adding field 'PredicateObjectIndex.parent'
        db.add_column(u'sense_predicateobjectindex', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sense.PredicateObjectIndex'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PredicateObjectIndex.parent'
        db.delete_column(u'sense_predicateobjectindex', 'parent_id')

        # Adding unique constraint on 'PredicateObjectIndex', fields ['context', 'predicate', 'object']
        db.create_unique(u'sense_predicateobjectindex', ['context_id', 'predicate_id', 'object_id'])
    ...
    models = {
        ...
        u'sense.predicateobjectindex': {
            'Meta': {'unique_together': "(('context', 'parent', 'predicate', 'object'),)", 'object_name': 'PredicateObjectIndex', 'index_together': "(('context', 'parent', 'predicate', 'object'), ('context', 'predicate', 'object'))"},
        ...
        u'sense.predicateobjectindextoself': {
            'Meta': {'unique_together': "(('lower', 'upper'),)", 'object_name': 'PredicateObjectIndexToSelf'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'entropy': ('django.db.models.fields.FloatField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lower': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lower_poi_m2m'", 'to': u"orm['sense.PredicateObjectIndex']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
            'upper': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'upper_poi_m2m'", 'to': u"orm['sense.PredicateObjectIndex']"})
        },
        u'sense.sense': {
