...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredicateObjectIndex.enabled'
        db.add_column(u'sense_predicateobjectindex', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredicateObjectIndex.enabled'
        db.delete_column(u'sense_predicateobjectindex', 'enabled')
