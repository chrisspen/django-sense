...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InferenceRule.simple_description'
        db.add_column(u'sense_inferencerule', 'simple_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InferenceRule.simple_description'
        db.delete_column(u'sense_inferencerule', 'simple_description')
    ...
    models = {
        ...
        u'sense.sense': {
            'Meta': {'ordering': "('word__text',)", 'unique_together': "(('source', 'word', 'pos', 'definition'), ('source', 'word', 'pos', 'wordnet_id'))", 'object_name': 'Sense'},
        ...
        u'sense.triple': {
            'Meta': {'ordering': "('_text',)", 'unique_together': "(('subject', 'subject_triple', 'predicate', 'object', 'object_triple'),)", 'object_name': 'Triple', 'index_together': "(('predicate', 'object', 'object_triple'), ('inferred', 'deleted'))"},
            '_text': ('django.db.models.fields.TextField', [], {'null': 'True', 'db_column': "'text'", 'blank': 'True'}),
