...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Word.text_length'
        db.add_column(u'sense_word', 'text_length',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Word.text_length'
        db.delete_column(u'sense_word', 'text_length')
    ...
    models = {
        ...
        u'sense.tripleflow': {
            'Meta': {'ordering': "('context', 'rindex')", 'unique_together': "(('context', 'parent', 'index'),)", 'object_name': 'TripleFlow', 'index_together': '()'},
            ...
            'rindex': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'triple': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flows'", 'to': u"orm['sense.Triple']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'})
        },
        u'sense.tripleinference': {
            'Meta': {'ordering': "('-inferred_weight',)", 'unique_together': "(('inferred_triple', 'inference_rule', 'inference_arguments_cache'),)", 'object_name': 'TripleInference'},
        ...
        u'sense.word': {
            ...
            'text_length': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'trusted': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
