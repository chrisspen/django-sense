...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context._triple_count'
        db.add_column(u'sense_context', '_triple_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, db_column='triple_count', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context._triple_count'
        db.delete_column(u'sense_context', 'triple_count')
