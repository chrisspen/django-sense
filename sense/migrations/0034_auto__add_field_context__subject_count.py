...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context._subject_count'
        db.add_column(u'sense_context', '_subject_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, db_column='subject_count', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context._subject_count'
        db.delete_column(u'sense_context', 'subject_count')
    ...
    models = {
        ...
        u'sense.predicateobjectindex': {
            'Meta': {'ordering': "('-entropy',)", 'unique_together': "(('context', 'parent', 'predicate', 'object'),)", 'object_name': 'PredicateObjectIndex', 'index_together': "(('context', 'parent', 'predicate', 'object'), ('context', 'predicate', 'object'))"},
