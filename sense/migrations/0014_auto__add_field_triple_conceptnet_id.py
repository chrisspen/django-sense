...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Triple.conceptnet_id'
        db.add_column(u'sense_triple', 'conceptnet_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Triple.conceptnet_id'
        db.delete_column(u'sense_triple', 'conceptnet_id')
    ...
    models = {
        ...
        u'sense.triple': {
            ...
            'conceptnet_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
