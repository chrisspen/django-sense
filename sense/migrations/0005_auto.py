...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field senses on 'Context'
        m2m_table_name = db.shorten_name(u'sense_context_senses')
        ...
        db.create_unique(m2m_table_name, ['context_id', 'sense_id'])

        # Adding M2M table for field all_senses on 'Context'
        m2m_table_name = db.shorten_name(u'sense_context_all_senses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('context', models.ForeignKey(orm[u'sense.context'], null=False)),
            ('sense', models.ForeignKey(orm[u'sense.sense'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field senses on 'Context'
        db.delete_table(db.shorten_name(u'sense_context_senses'))

        # Removing M2M table for field all_senses on 'Context'
        db.delete_table(db.shorten_name(u'sense_context_all_senses'))
