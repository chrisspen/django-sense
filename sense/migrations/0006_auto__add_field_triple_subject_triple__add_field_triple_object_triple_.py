...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Triple.subject_triple'
        db.add_column(u'sense_triple', 'subject_triple',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subject_triple_triples', null=True, to=orm['sense.Triple']),
                      keep_default=False)

        # Adding field 'Triple.object_triple'
        db.add_column(u'sense_triple', 'object_triple',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='object_triple_triples', null=True, to=orm['sense.Triple']),
                      keep_default=False)


        # Changing field 'Triple.subject'
        db.alter_column(u'sense_triple', 'subject_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sense.Sense']))
        ...
        # Adding index on 'Triple', fields ['predicate', 'object', 'object_triple']
        db.create_index(u'sense_triple', ['predicate_id', 'object_id', 'object_triple_id'])


    def backwards(self, orm):
        # Removing index on 'Triple', fields ['predicate', 'object', 'object_triple']
        db.delete_index(u'sense_triple', ['predicate_id', 'object_id', 'object_triple_id'])
        ...
        # Deleting field 'Triple.subject_triple'
        db.delete_column(u'sense_triple', 'subject_triple_id')

        # Deleting field 'Triple.object_triple'
        db.delete_column(u'sense_triple', 'object_triple_id')


        # Changing field 'Triple.subject'
        db.alter_column(u'sense_triple', 'subject_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sense.Sense']))
    ...
    models = {
        ...
        u'sense.context': {
            ...
            'all_senses': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'senses'", 'symmetrical': 'False', 'to': u"orm['sense.Sense']"}),
            ...
            'senses': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'direct_senses'", 'symmetrical': 'False', 'to': u"orm['sense.Sense']"}),
        ...
        u'sense.triple': {
            'Meta': {'unique_together': "(('subject', 'subject_triple', 'predicate', 'object', 'object_triple'),)", 'object_name': 'Triple', 'index_together': "(('predicate', 'object', 'object_triple'), ('inferred', 'deleted'))"},
