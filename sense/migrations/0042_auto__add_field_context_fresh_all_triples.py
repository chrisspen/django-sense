...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context.fresh_all_triples'
        db.add_column(u'sense_context', 'fresh_all_triples',
    ...
    def backwards(self, orm):
        # Deleting field 'Context.fresh_all_triples'
        db.delete_column(u'sense_context', 'fresh_all_triples')
