...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredicateObjectIndex.po_hash'
        db.add_column(u'sense_predicateobjectindex', 'po_hash',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=700, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Triple.po_hash'
        db.add_column(u'sense_triple', 'po_hash',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=700, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredicateObjectIndex.po_hash'
        db.delete_column(u'sense_predicateobjectindex', 'po_hash')

        # Deleting field 'Triple.po_hash'
        db.delete_column(u'sense_triple', 'po_hash')
