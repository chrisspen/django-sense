...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InferenceRule.description'
        db.add_column(u'sense_inferencerule', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InferenceRule.description'
        db.delete_column(u'sense_inferencerule', 'description')
