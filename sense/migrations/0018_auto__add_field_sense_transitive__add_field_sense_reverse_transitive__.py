...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sense.transitive'
        db.add_column(u'sense_sense', 'transitive',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sense.reverse_transitive'
        db.add_column(u'sense_sense', 'reverse_transitive',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding index on 'Word', fields ['sense_count']
        db.create_index(u'sense_word', ['sense_count'])


    def backwards(self, orm):
        # Removing index on 'Word', fields ['sense_count']
        db.delete_index(u'sense_word', ['sense_count'])

        # Deleting field 'Sense.transitive'
        db.delete_column(u'sense_sense', 'transitive')

        # Deleting field 'Sense.reverse_transitive'
        db.delete_column(u'sense_sense', 'reverse_transitive')
