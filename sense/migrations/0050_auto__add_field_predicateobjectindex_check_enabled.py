...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredicateObjectIndex.check_enabled'
        db.add_column(u'sense_predicateobjectindex', 'check_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredicateObjectIndex.check_enabled'
        db.delete_column(u'sense_predicateobjectindex', 'check_enabled')
