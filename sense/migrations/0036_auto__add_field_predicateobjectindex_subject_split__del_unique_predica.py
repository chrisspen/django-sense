...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'sense.predicateobjectindex': {
            'Meta': {'ordering': "('-entropy',)", 'unique_together': "(('context', 'parent', 'predicate', 'object', 'subject_split'),)", 'object_name': 'PredicateObjectIndex', 'index_together': "(('context', 'parent', 'predicate', 'object', 'subject_split'), ('context', 'predicate', 'object', 'subject_split'), ('context', 'parent', 'predicate', 'object'), ('context', 'predicate', 'object'))"},
            ...
            'subject_split': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'subject_index'", 'null': 'True', 'to': u"orm['sense.Sense']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'})
        },
