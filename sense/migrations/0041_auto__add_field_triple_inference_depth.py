...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Triple.inference_depth'
        db.add_column(u'sense_triple', 'inference_depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Triple.inference_depth'
        db.delete_column(u'sense_triple', 'inference_depth')
