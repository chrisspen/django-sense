...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context.top_parent'
        db.add_column(u'sense_context', 'top_parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='top_children', null=True, to=orm['sense.Context']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.top_parent'
        db.delete_column(u'sense_context', 'top_parent_id')
