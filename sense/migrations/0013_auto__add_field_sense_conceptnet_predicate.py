...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sense.conceptnet_predicate'
        db.add_column(u'sense_sense', 'conceptnet_predicate',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sense.conceptnet_predicate'
        db.delete_column(u'sense_sense', 'conceptnet_predicate')
